# Generated by Django 2.2.3 on 2020-04-13 15:30
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page_title', models.CharField(blank=True, default='Features', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('page_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='wagtailcore.Page')),
                ('page_title', models.CharField(blank=True, default='Pricing', max_length=50)),
            ],
            options={
                'abstract': False,
            },
